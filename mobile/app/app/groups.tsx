...
const styles = StyleSheet.create({
  ...
  broadcastTextInput: {
    ...
    borderRadius: 10,
    paddingHorizontal: 12,
    // asymmetric padding shifts placeholder down to look centred at single-line height, since textAlignVertical "top" pushes text to the top as the field grows
    paddingTop: 10,
    paddingBottom: 6,
    fontSize: 15,
    lineHeight: 20,
